...
/**
 * @file roomba.hpp
 * @author Abhinav Garg (nmangla@umd.edu)
 * @brief Roomba Walker, avoid obstacles if any,class definition
 * @version 0.1
 * @date 2022-12-14
...
#ifndef ROS2_WS_SRC_ROOMBA_INCLUDE_ROOMBA_HPP_
#define ROS2_WS_SRC_ROOMBA_INCLUDE_ROOMBA_HPP_
...
/**
 * @brief Classs definination for RoomBa
 *
 */
class RoomBa : public rclcpp::Node {
 public:
  RoomBa() : Node("walker"), state_(FORWARD) {
    ...
    subscription_ = this->create_subscription<LASER>(
        "scan", default_qos, subCallback);  // subscribing  to topic scan
  }
 ...
 private:
  ...
  void subscribe_callback(const LASER& msg) { laser_ = msg; }
  /**
...
#endif  // ROS2_WS_SRC_ROOMBA_INCLUDE_ROOMBA_HPP_
